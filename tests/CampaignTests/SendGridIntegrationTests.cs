...
namespace CampaignTests
{
    public class SendGridIntegrationTests
    {
        ...
        public void Setup()
        {
            _emailSender = new SendGridEmailService(new IdentitySettings(), new Moq.Mock<IBackgroundServiceTaskQueue>().Object, new Moq.Mock<IAppConfig>().Object,  new Moq.Mock<IAdminLogger>().Object);
        }
